-- ============================================================================
-- 0041: Arreglar ambigüedad scheduled_for en client_create_reservation + bucket avatars
-- ============================================================================
-- 1) PL/pgSQL: la variable scheduled_for chocaba con la columna homónima en
--    INSERT...SELECT, provocando "column reference scheduled_for is ambiguous".
-- 2) Bucket público `avatars` con RLS: cada usuario solo sube/borra en su carpeta
...
-- Bucket de fotos de perfil (público para lectura; escritura solo en carpeta del usuario)
