-- Combined migration: apply 0004 contact fields + fix pgcrypto search_path
-- Safe to run multiple times (CREATE OR REPLACE, DROP VIEW IF EXISTS)

-- 1. Update client_create_reservation with contact fields and fixed search_path
...
-- 2. Recreate reservations_detail_view
